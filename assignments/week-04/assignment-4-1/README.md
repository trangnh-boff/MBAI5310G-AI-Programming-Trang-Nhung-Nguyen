...
One limitation is that the dataset is simplified and may not include all real-world factors that affect payment behavior. Real payment behavior may depend on customer financial stress, contract terms, approval workflows, seasonal business cycles, economic conditions, or customer relationships.

Because of this, the model should support human judgment and should not replace staff review.
